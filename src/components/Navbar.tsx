  ...
  return (
    <nav className="bg-[#641311] text-white fixed w-full z-20 top-0 shadow-lg transition-all duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex md:hidden">
            <button
              ...
              className="p-2 rounded-full text-[#cc936b] hover:text-white hover:bg-[#cc936b]/10 focus:outline-none transition-colors duration-200"
          ...
          <div className="flex-1 flex justify-center md:flex-initial">
            <LinkWrapper
              href="/"
              className="font-moondance text-3xl sm:text-4xl md:text-5xl text-[#cc936b] tracking-wide hover:text-[#cc936b]/80 transition-colors duration-300 whitespace-nowrap"
            >
              Cláudia Andrade
            </LinkWrapper>
          </div>
        ...
        {/* Mobile menu */}
        {isOpen && (
          <div className="md:hidden absolute w-full left-0 top-20 bg-[#641311] shadow-lg animate-slideDown">
            <div className="px-4 pt-4 pb-6 space-y-4">
              {navItems.map((item) => (
                <LinkWrapper
                  key={item.name}
                  href={item.href}
                  className="font-[Poppins-light] block px-4 py-2 text-[#cc936b] hover:text-white hover:bg-[#cc936b]/10 text-xl sm:text-2xl rounded-md transition-colors duration-200"
